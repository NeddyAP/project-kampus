                ...
                <div className="container mx-auto py-10">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Silahkan isi data berikut untuk mengajukan magang</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid gap-6 sm:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {errors.dosen_id && <p className="text-destructive text-sm">{errors.dosen_id}</p>}
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.company_address && <p className="text-destructive text-sm">{errors.company_address}</p>}
                                </div>
                                ...
                                <div className="grid gap-6 sm:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        />
                                        {errors.company_phone && <p className="text-destructive text-sm">{errors.company_phone}</p>}
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        />
                                        {errors.supervisor_phone && <p className="text-destructive text-sm">{errors.supervisor_phone}</p>}
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.supervisor_name && <p className="text-destructive text-sm">{errors.supervisor_name}</p>}
                                </div>
                                        ...
                                        <Popover>
                                            <PopoverTrigger asChild>
                                                ...
                                                >
                                                    ...
                                                    {data.start_date ? formatDate(data.start_date) : <span>Pilih tanggal mulai</span>}
                                                </Button>
                                            </PopoverTrigger>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Popover>
                                            <PopoverTrigger asChild>
                                                ...
                                                >
                                                    <CalendarIcon className="mr-2 h-4 w-4" />
                                                    {data.end_date ? formatDate(data.end_date) : <span>Pilih tanggal selesai</span>}
                                                </Button>
                                            </PopoverTrigger>
                                            <PopoverContent className="w-auto p-0" align="start">
                                                <Calendar
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="cover_letter" type="file" accept=".pdf" onChange={handleFileChange} />
                                    <p className="text-muted-foreground text-sm">Unggah surat pengantar dalam format PDF (maksimal 2MB)</p>
