...
const EditUser = ({ user, roles }: Props) => {
    const [isSubmitting, setIsSubmitting] = useState(false);
    const [formData, setFormData] = useState({
        name: user.name,
        email: user.email,
        password: '', // Password kosong karena optional saat update
        role: user.role,
        // Data dosen
        nip: user.profile?.nip || '',
        bidang_keahlian: user.profile?.bidang_keahlian || '',
        // Data mahasiswa
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Filter out empty password from data
